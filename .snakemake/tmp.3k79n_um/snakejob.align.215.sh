...
--wait-for-files /work/users/s/e/seyoun/CQTL_AI/.snakemake/tmp.3k79n_um output/trim/CQTL_AM7780_CTL_Ankle_1_R1_val_1.fq.gz output/trim/CQTL_AM7780_CTL_Ankle_1_R2_val_2.fq.gz --latency-wait 500 \
