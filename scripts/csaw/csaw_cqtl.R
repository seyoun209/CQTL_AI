...
cqtl_bam_files <- dir(cqtl_bam_dir, pattern="sorted_wasp.bam$", full.names=TRUE) 

output_dir <- "/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw"
...
load("/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_fragment_analysis.RData")
...
save(data, file="/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_CSAW_windows_count")
save(my.regions, 
     file="/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_regions.RData")

reg.counts <- regionCounts(cqtl_bam_files, my.regions, ext=multi.frag.len, param=pe.param)
counts=assay(reg.counts)
save(counts,my.regions, results, file=paste0("/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_CSAW_windowCounts.Rdata"))
#------------------------------------------------------------------------------
...
load("/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_fragment_analysis.RData")
load("/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_CSAW_windows_count")
load("/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_regions.RData")
load("/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_CSAW_windowCounts.Rdata")
...
save(GCcontent, sample_names, 
     file = '/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_GCContent.RData')
...
save(cqnNormFactors, results, 
     file = '/work/users/s/e/seyoun/CQTL_AI/output/peaks/csaw/CQTL_cqnNormFactors.RData')